            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="proses_produk.php?action=update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-text">Gambar saat ini: <?php echo htmlspecialchars($product['image']); ?></div>
